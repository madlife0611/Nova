<?php 
	...
	class CustomersDetailController extends Controller{
		...
		public function index(){
			...
			$this->loadView("CustomersDetailView.php",["data"=>$data,"numPage"=>$numPage]);
		}
		public function update(){
			...
			//goi view, truyen du lieu ra view
			$this->loadView("CustomersDetailView.php",["record"=>$record,"action"=>$action]);
		}
